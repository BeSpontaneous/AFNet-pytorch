...
parser.add_argument('--path_backbone', type=str)
...
parser.add_argument('--rt_begin', default=1, type=int)
parser.add_argument('--rt_end', default=50, type=int)
parser.add_argument('--rt', default=0, type=float)
parser.add_argument('--t0', default=5.0, type=float)
parser.add_argument('--t1', default=1e-2, type=float)
parser.add_argument('--t_end', default=50, type=int)
parser.add_argument('--temp', default=1, type=float)
parser.add_argument('--lambda_rt', default=1, type=float)
parser.add_argument('--round', default="", type=str)